...
import { getMemberProfileAPI, patchMemberProfileAPI } from '@/services/profile'
...
const onSubmit = async () => {
  const res = await patchMemberProfileAPI(userInfo.value)
  // 更新 store 数据
    ...
    <view class="form">
      ...
      <view class="form-content">
        ...
        <view class="form-item">
          ...
          <input class="input" type="password" placeholder="如需修改请填写密码" v-model="userInfo.password" />
        </view>
      </view>
      <!-- 提交按钮 -->
