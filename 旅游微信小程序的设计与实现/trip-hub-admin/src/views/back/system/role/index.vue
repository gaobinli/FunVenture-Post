  ...
  <div class="layout-container">
      ...
      <div class="layout-container-form-search">
        <el-form :inline="true" :model="params" class="demo-form-inline">
          <el-form-item label="角色编码：">
              <el-input v-model="query.qp_code_like" placeholder="请输入角色编码" clearable></el-input>
          </el-form-item>
          <el-form-item label="角色名称：">
              <el-input v-model="query.qp_name_like" placeholder="请输入角色名称" clearable></el-input>
          </el-form-item>
          <el-form-item>
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="modifyTime" label="修改时间" align="center" :formatter='handleTime' />
...
import { dataList, del } from '@/api/back/system/role'
