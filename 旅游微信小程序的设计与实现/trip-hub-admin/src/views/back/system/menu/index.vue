      ...
      <div class="layout-container-form-search">
        <el-form :inline="true" :model="params" class="demo-form-inline">
          <el-form-item label="菜单编码：">
              <el-input v-model="query.qp_code_like" placeholder="请输入菜单编码" clearable></el-input>
          </el-form-item>
          <el-form-item label="菜单名称：">
              <el-input v-model="query.qp_name_like" placeholder="请输入菜单名称" clearable></el-input>
          </el-form-item>
          <el-form-item>
...
import { dataList, del } from '@/api/back/system/menu'
