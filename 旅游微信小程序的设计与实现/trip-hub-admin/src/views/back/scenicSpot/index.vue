  ...
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="coverUrl" label="景点封面图" align="center">
        ...
        <el-table-column prop="url" label="景点导航图" align="center">
          <template #default="scope">
              <el-image
                  style="width: 100px; height: 100px"
                  :src="scope.row.url"
        ...
        <el-table-column prop="address" label="景点地址" align="center" />
        <el-table-column prop="price" label="门票价格" align="center" />
        <el-table-column prop="inventory" label="库存" align="center" />
        <el-table-column prop="shortRecommend" label="简单介绍" align="center" />
...
import { dataList, del } from '@/api/back/scenicSpot'
...
export default defineComponent({
  ...
  setup() {
    ...
    // 新增弹窗功能
    const handleAdd = () => {
      router.push({path:'/scenicSpot/add'});
    }
    // 编辑弹窗功能
    const handleEdit = (row: object) => {
      router.push({path:'/scenicSpot/update', query: {id: row.id} });
    }
    getTableData(true)
    return {
      Plus,
