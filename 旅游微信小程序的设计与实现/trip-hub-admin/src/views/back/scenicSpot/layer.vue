  ...
  <Layer :layer="layer" @confirm="submit" ref="layerDom">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px" style="margin-right:30px;">
      ...
      <el-form-item label="景点导航图：" prop="url">
        <el-input v-model="form.url" placeholder="请输入景点导航图"></el-input>
      </el-form-item>
      ...
      <el-form-item label="景点介绍：" prop="introduce">
        <el-input v-model="form.introduce" placeholder="请输入景点介绍"></el-input>
      </el-form-item>
      <el-form-item label="门票价格：" prop="price">
        <el-input v-model="form.price" placeholder="请输入门票价格"></el-input>
      </el-form-item>
