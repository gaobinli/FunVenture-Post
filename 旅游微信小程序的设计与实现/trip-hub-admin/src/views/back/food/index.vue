  ...
  <div class="layout-container">
    ...
    <div class="layout-container-table">
      ...
      >
        ...
        <el-table-column prop="url" label="美食封面" align="center">
        ...
        <el-table-column :label="$t('message.common.handle')" align="center" fixed="right" width="250">
          <template #default="scope">
...
import { dataList, del } from '@/api/back/food'
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleEdit = (row: object) => {
      ...
      // layer.row = row
      // layer.show = true
      router.push({path:'/food/update', query: {id: row.id} });
    }
    getTableData(true)
    return {
      Plus,
